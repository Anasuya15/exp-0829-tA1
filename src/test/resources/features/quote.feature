    ...
    Given I open url "http://quote-stage.portnov.com"
      ...
      Scenario: Successful submission
       Given I open url "http://quote-stage.portnov.com"
        ...
        Then I type "Anu" into element with xpath "//input[@id='firstName']"
        Then I type "Pradhan" into element with xpath "//input[@id='lastName']"
        And I click on element with xpath "//button[span[text()='Save']]"
        Then I type "Anu_test" into element with xpath "//input[@name='username']"
...
#        Then element with xpath "//input[@name='confirmPassword']" should be enabled
        Then I type "123abc" into element with xpath "//input[@name='confirmPassword']"
        And  I switch to iframe with xpath "//iframe[@name='additionalInfo']"
        Then  I type "Contact Person Name" into element with xpath "//input[@id='contactPersonName']"
        ...
        And element with xpath "//b[@name='firstName']" should contain text "Anu"
        And element with xpath "//b[@name='username']" should contain text "Anu_test"
